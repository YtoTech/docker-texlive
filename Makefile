...
push-all-tags:
	docker image tag yoant/docker-texlive:debian yoant/docker-texlive:debian-2024
	docker image tag yoant/docker-texlive:alpine yoant/docker-texlive:alpine-2024
