...
A [Docker image](https://hub.docker.com/r/yoant/docker-texlive) based on Debian (Bullseye) or Alpine (3.15) with the latest vanilla [Texlive](https://www.tug.org/texlive/quickinstall.html) distribution (2022).
